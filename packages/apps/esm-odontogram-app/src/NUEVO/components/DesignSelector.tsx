      ...
      <div style={{ padding: "20px" }}>
        ...
        >
          {designs.map((design: any) => {
            ...
            const appliedFinding = existingFindings.find(finding => 
              finding.designNumber === design.number
            );
            const isApplied = !!appliedFinding;

            // Look up the suboption name for applied designs
            const appliedTipo = isApplied && suboptions && appliedFinding?.subOptionId != null
