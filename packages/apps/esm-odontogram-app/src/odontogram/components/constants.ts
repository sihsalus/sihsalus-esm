...
export const TOOTH_DESIGN_COMPONENT_MAP: Record<string, Record<string, React.ComponentType<{ strokeColor: string }>>> = {
  '3':  { '1': Finding3Design1 },
  '4':  { '1': Finding4Design1 },
  ...
  '11': { '1': EllipseDesignLeft as unknown as React.ComponentType<{ strokeColor: string }>, '2': EllipseDesignRight as unknown as React.ComponentType<{ strokeColor: string }>, '3': EllipseDesignLeftAndRight as unknown as React.ComponentType<{ strokeColor: string }> },
