...
function ImageThumbnail(props: ThumbnailProps): React.JSX.Element {
  return <img className={styles.imageThumbnail} src={props.src} alt={props.title} />;
}

function PDFThumbnail(_props: ThumbnailProps): React.JSX.Element {
  return (
...
function OtherThumbnail(_props: ThumbnailProps): React.JSX.Element {
  return (
    <div className={styles.pdfThumbnail} role="button" tabIndex={0}>
