...
export function getMainBundle(project: PackageManifest) {
...
export function getAppRoutes(sourceDirectory: string, project: PackageManifest): Record<string, unknown> {
